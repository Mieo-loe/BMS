    ...
    <div class="nano">
        <div class="nano-content">
            <ul>
                ...
                <li ><a href="${pageContext.request.contextPath}/staff/stafflist"><i class="ti-user"></i>员工管理</a></li>
                <li ><a href="${pageContext.request.contextPath}/staff/frame_plus"><i class="ti-money"></i> 销售情况 </a></li>
            </ul>
        </div>
    </div>
</div><!-- /# sidebar -->
